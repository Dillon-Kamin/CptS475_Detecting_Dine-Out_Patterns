...
# Vis based on visit length???

# Replace loc with restaurants name or code??? (use mutate(buffer = case_when())...)
...
# Classify visits based on time spent there, time gaps, location, etc.
